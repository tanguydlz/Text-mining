          ...
          ")),
            ...
            conditionalPanel(condition="input.tabselected==1",
                             ...
                             selectInput("selectVar", label = h3("Variable to select"),
                                         choices = list("Preoccupation" = 2, "Motif de consultation" = 3, "Diagnostic"=4, "Jeux et activités"=5, "Sommeil"=6 ,"Entrée en contact"=7,"Habitute de l'enfant"=8,"Qui"=9,"Antécédents"=10,"Raison"=11),
                                         selected = 2),
